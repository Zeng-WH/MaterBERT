...
class DataProcessor(object):
    ...
    def _read_tsv(cls, input_file, quotechar=None):
        ...
        with tf.gfile.Open(input_file, "r") as f:
            ...
            return lines
#2020/8/3
class MaterProcessor(DataProcessor):
    """Processor for the Inorganic Material data"""
    def get_train_examples(self, data_dir):
        """See base class"""
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        #tf.merged_summary_op=tf.summary.merge_all()
        #2020/8/1
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate, num_train_steps,
    ...
    def model_fn(features, labels, mode, params):
        ...
        precision_out = tf.metrics.precision(labels=label_ids, predictions=predictions, weights=is_real_example)
        f1_out = (2 * precision_out[0] * recall_out[0] / (precision_out[0] + recall_out[0]), recall_out[1])
        tf.summary.scalar('recall_curve', recall_out[1])
        tf.summary.scalar('precision_curve', precision_out[1])
        tf.summary.scalar('f1_curve', f1_out[1])
        #2020/8/2
