...
class FormationProcessor(DataProcessor):
    ...
    def get_train_examples(self):
        ...
        return self._create_examples(
            read_numpy('./element_name1.npy', './element_name2.npy', 'element_num.npy'), "train"
        )

    def get_dev_examples(self):
        """See base class"""
        return self._create_examples(
            read_numpy('./element_name1.npy', './element_name2.npy', 'element_num.npy'), "valid"
        )
...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained('/home/ypd-19-2/SpERT/model/bertbase-20210122T060007Z-001/bertbase')
    ...
    if args.do_train:
        ...
        #label_map = {i : label for i, label in enumerate(label_list,1)}
        model_config = {"bert_model":args.bert_model,"do_lower":args.do_lower_case,"max_seq_length":args.max_seq_length,"num_labels":1}
...
'''
exa = FormationProcessor()
t = exa.get_train_examples()
tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
f = convert_examples_to_features(t, 128, tokenizer)
print('1')
'''
